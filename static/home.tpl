...
<html lang="en">
  <head>
    <title>Golang Mini Project</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <link rel="icon" type="image/x-icon" href="/static/tasks.ico" />
    ...
    <style type="text/css">
      ...
      .error{
        border: 2px solid #5ab9ea !important;
      }
      .not-checked{
        background: #c1c8e4;
        color: #8860d0;
                  ...
                  <div class="card-body">
                      <form v-on:submit.prevent>
                        <div class="input-group">
                          <input type="text" v-model="todo.title" v-on:keyup="checkForEnter($event)" class="form-control custom-input" :class="{ 'error': showError }" placeholder="Insert the task here">
                          <span class="input-group-btn">
                            <button class="btn custom-button" :class="{'btn-primary' : !enableEdit, 'btn-warning' : enableEdit}" type="button"  v-on:click="addTodo"><span :class="{'fa fa-plus' : !enableEdit, 'fa fa-edit' : enableEdit}"></span></button>
                          </span>
                        </div>
                      </form>
                      <ul class="list-group">
